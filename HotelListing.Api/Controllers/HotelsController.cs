...
public class HotelsController : ControllerBase
{
	...
	{
		new Hotel { Id = 1, Name = "Grand Plaza", Address = "123 Main St", Rating =
			4.5},
		new Hotel { Id = 2, Name = "Ocean View", Address = "456 Beach Rd", Rating =
			4.8 }
	};
	...
	public ActionResult<Hotel> Post([FromBody] Hotel newHotel)
	{
		...
		{
			return BadRequest("Hotel with this Id alrady exists");
		}
